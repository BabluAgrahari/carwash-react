...
export default function Edit(props) {
  ...
  const handleCheckbox = (e) => {
    ...
    let checkedv = e.target.checked ? true : false;
    setCheckbox({ ...checkbox, [e.target.name]: val });
    setChecked({...checked,[e.target.name]: checkedv });
  };
  ...
  const fetchCatgory = () => {
    ...
    http.get("/shop-owner/" + id, { headers }).then((res) => {
      ...
      setChecked({
        store_status: response.store_status ? true : false,
        verified_store: response.verified_store ? true : false,
      });
      ...
      var bankTemplate11 = [];
      {
        response.bank_details &
          response.bank_details.map((bank, index) => {
            bankTemplate11.push({
  ...
  function submit(e) {
    ...
    inputsV.append("verified_store", checkbox.verified_store);
                        ...
                        <div className="form-group col-md-6">
                          ...
                          <div className="custom-control custom-switch custom-switch-off-danger custom-switch-on-success">
                            <input
                              ...
                              id="customSwitch1"
                              name="verified_store"
                              checked={checked.verified_store}
                              value={1}
                              onClick={handleCheckbox}
                            />
                            <label
