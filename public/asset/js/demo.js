...
(function ($) {
  ...
  setTimeout(function () {
    if (window.___browserSync___ === undefined && Number(sessionStorage.getItem('AdminLTE:Demo:MessageShowed')) < Date.now()) {
      sessionStorage.setItem('AdminLTE:Demo:MessageShowed', (Date.now()) + (15 * 60 * 1000))
